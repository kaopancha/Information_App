...
{
    public partial class Edit_internet : Form
    {
        ...
        public Edit_internet(string Pid)
        {
            InitializeComponent();
        ...
        private void Edit_internet_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                connection.Open();
                string query1 = "SELECT * FROM about_email where title_type = 'I' and number = " + number + ";";
        ...
        private void edit_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dialog == DialogResult.Yes)
                {
                    ...
                    query += "', picture = @pic";
                    query += ", sentinfo_date = @sentinfo WHERE title_type = 'I' and number = " + number + ";";
        ...
        private void delete_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dialog == DialogResult.Yes)
                {
                    connection.Open();
                    //ลบข้อมูล
                    string query = "DELETE FROM about_email WHERE title_type = 'I' and number = " + number + "";
                    cmd.CommandText = query;
                    cmd.ExecuteNonQuery();
