...
{
    public partial class Edit_email : Form
    {
        ...
        private void Edit_email_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                connection.Open();
                string query1 = "SELECT * FROM about_email where title_type = 'E' and number = " + number + ";";
        ...
        private void edit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dialog == DialogResult.Yes)
                {
                    ...
                    query += "', picture = @pic";
                    query += ", sentinfo_date = @sentinfo WHERE title_type = 'E' and number = " + number + ";";
        ...
        private void delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dialog == DialogResult.Yes)
                {
                    connection.Open();
                    //ลบข้อมูล
                    string query = "DELETE FROM about_email WHERE title_type = 'E' and number = " + number + "";
                    cmd.CommandText = query;
                    cmd.ExecuteNonQuery();
