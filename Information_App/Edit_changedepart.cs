...
{
    public partial class Edit_changedepart : Form
    {
        ...
        public Edit_changedepart(string Pid)
        {
            InitializeComponent();
        ...
        private void Edit_changedepart_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                connection.Open();
                string query1 = "SELECT * FROM about_email where title_type = 'C' and number = " + number + ";";
        ...
        private void edit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dialog == DialogResult.Yes)
                {
                    ...
                    query += "', picture = @pic";
                    query += ", sentinfo_date = @sentinfo WHERE title_type = 'C' and number = " + number + ";";
        ...
        private void delete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dialog == DialogResult.Yes)
                {
                    connection.Open();
                    //ลบข้อมูล
                    string query = "DELETE FROM about_email WHERE title_type = 'C' and number = " + number + "";
                    cmd.CommandText = query;
                    cmd.ExecuteNonQuery();
