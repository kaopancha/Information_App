...
{
    public partial class Changedepart_Form : Form
    {
        ...
        private void Changedepart_Form_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //นับจำนวนรายการ
                connection.Open();
                string query1 = "SELECT COUNT(*) as mycount FROM about_email WHERE title_type = 'C';";
                ...
                connection.Open();
                cmd2.CommandText = "SELECT MIN(getinfo_date) AS from_date FROM about_email WHERE title_type = 'C'";
            ...
            try
            {
                ...
                c1.gridview("select * from about_email WHERE title_type = 'C'", dt);
        ...
        private void Changedepart_Form_Shown(object sender, EventArgs e)
        {
            //ลบ highlight เริ่มต้น
            dataGridView1.ClearSelection();
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (textBox1.Text == "")
                {
                    condition = "where title_type = 'C' and getinfo_date between #" + newfrom + "# and #" + newto + "#";
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        condition = "where title_type = 'C' and " + datatype + " like '%" + textBox1.Text + "%' and getinfo_date between #" + newfrom + "# and #" + newto + "#";
                    }
                }
                //เคลียค่าในตาราง
                dt.Rows.Clear();
        ...
        {
            Add_changedepart m2 = new Add_changedepart();
            m2.Show();
        }
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            Edit_changedepart f4 = new Edit_changedepart(Pid);
            f4.Show();
        }
        ...
        private void print_Click(object sender, EventArgs e)
        {
            if (dataGridView1.Rows.Count > 0)
            {
                ...
                sfd.FileName = "ข้าราชการย้ายสังกัด.pdf";       //ชื่อไฟล์เริ่มต้น
                ...
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    if (!fileError)
                    {
                        try
                        {
                            ...
                            PdfPCell cell;
                            //หัวกระดาษ
                            p = new Phrase("กรณีข้าราชการย้ายสังกัดเข้ามาดำรงตำแหน่งที่ โรงเรียนนายเรืออากาศนวมินทกษัตริยาธิราช", ftitle);
                            cell = new PdfPCell(p);
                            ...
                            p = new Phrase("(ขอใช้งาน Internet ภายในโรงเรียนนายเรืออากาศนวมินทกษัตริยาธิราช)", ftitle);
                            cell = new PdfPCell(p);
                            cell.Colspan = 13;
                            cell.HorizontalAlignment = Element.ALIGN_CENTER;
                            cell.Border = iTextSharp.text.Rectangle.NO_BORDER;
