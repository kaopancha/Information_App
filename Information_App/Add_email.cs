...
{
    public partial class Add_email : Form
    {
        ...
        private void Add_email_Load(object sender, EventArgs e)
        {
            //กำหนดค่าเริ่มต้น
        ...
        private void add_Click_1(object sender, EventArgs e)
        {
            try
            {
                ...
                connection.Open();
                //เพิ่มข้อมูล
                cmd.CommandText = "INSERT INTO about_email (pre_name, th_name, th_last, depart, rank, phone, email, type, getinfo_date, mail_note, picture, title_type) values('" + pre_name.Text + "','" + th_name.Text + "','" + th_last.Text + "','" + depart.Text + "','" + rank.Text + "','" + phone.Text + "','" + email.Text + "','" + str_type + "','" + newdate + "','" + mail_note.Text + "', @pic, 'E')";
