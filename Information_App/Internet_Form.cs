    ...
    public partial class Internet_Form : Form
    {
        ...
        private void Internet_Form_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                //นับจำนวนรายการ
                connection.Open();
                string query1 = "SELECT COUNT(*) as mycount FROM about_email WHERE title_type = 'I';";
                ...
                connection.Open();
                cmd2.CommandText = "SELECT MIN(getinfo_date) AS from_date FROM about_email WHERE title_type = 'I'";
            ...
            try
            {
                ...
                c1.gridview("select * from about_email WHERE title_type = 'I'", dt);
        ...
        private void Internet_Form_Shown(object sender, EventArgs e)
        {
            //ลบ highlight เริ่มต้น
            dataGridView1.ClearSelection();
        }
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (textBox1.Text == "")
                {
                    condition = "where title_type = 'I' and getinfo_date between #" + newfrom + "# and #" + newto + "#";
                }
                else
                {
                    ...
                    else
                    {
                        ...
                        condition = "where title_type = 'I' and " + datatype + " like '%" + textBox1.Text + "%' and getinfo_date between #" + newfrom + "# and #" + newto + "#";
                    }
                }
                //เคลียค่าในตาราง
                dt.Rows.Clear();
        ...
        {
            Add_internet m2 = new Add_internet();
            m2.Show();
        }
        ...
        private void dataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                Edit_internet f4 = new Edit_internet(Pid);
                f4.Show();
            }
        }
        ...
        private void print_Click(object sender, EventArgs e)
        {
            if (dataGridView1.Rows.Count > 0)
            {
                ...
                sfd.FileName = "Internet เข้าใช้งานไม่ได้.pdf";     //ชื่อไฟล์เริ่มต้น
                ...
                if (sfd.ShowDialog() == DialogResult.OK)
                {
                    ...
                    if (!fileError)
                    {
                        try
                        {
                            ...
                            PdfPCell cell;
                            //หัวกระดาษ
                            p = new Phrase("กรณี Internet Authentication รร.นนก. เข้าใช้งานไม่ได้", ftitle);
                            cell = new PdfPCell(p);
